...
Generate resume bullets from one specified project markdown file.
The specified project Markdown file is SSOT.
...
Role
    ...
    default_role:
        The first role defined in knowledge/architecture/roles.md
...
Project md
    ...
    If not specified: throw error immediately
...
override: write
    ...
    Save output to:
        knowledge/products/cv/output_bullets/bullets_<project_name>.md
...
Required
    ...
    knowledge/architecture/roles.md
    knowledge/narratives/job_projects/<project_name>/<project_name>.md

Optional

    knowledge/narratives/job_experiences/<experience_name>.md
